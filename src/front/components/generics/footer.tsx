export function Footer() {
  return (
    <footer class="bg-[#161616] rounded-md p-6 mt-[400px] mb-3">
      <div class="flex flex-col md:flex-row gap-10 justify-between mb-6">
        <div class="company-section max-w-[300px]">
          ...
          <p class="mb-1">Your all in one solution to listen to music.</p>
          <div class="inline-flex items-center justify-center rounded-full border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 gap-1 focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden border-transparent bg-[#262626] text-secondary-foreground">
