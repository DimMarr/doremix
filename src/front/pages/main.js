...
export default function init() {
  ...
  const imgUrl1 = new URL('../assets/images/playlist1.jpg', import.meta.url).href;
  const imgUrl2 = new URL('../assets/images/playlist2.jpg', import.meta.url).href;
  const imgUrl3 = new URL('../assets/images/playlist3.jpg', import.meta.url).href;
  ...
  const track1 = createCard({ 
    title: 'Hip hop 90s', 
    image: imgUrl1,
    content:"Golden-era beats, raw flows, and timeless classics from the East Coast to the West Coast.",
    icon: svg1,
  ...
  const track2 = createCard({ 
    ...
    image: imgUrl2,
    content:"Heavy basslines, dark atmospheres, and the iconic sound that started the movement." ,
    icon: svg1, 
    className: 'px-0! max-w-[300px] shrink-0'
  });
  ...
  const track3 = createCard({ 
    ...
    image: imgUrl3,
    content: "Smooth synths, soft beats, and dreamy electronic textures for deep focus and late-night energy.",
    icon: svg1, 
    className: "px-0! max-w-[300px] shrink-0"
  });
